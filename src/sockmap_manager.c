...
/*static*/ struct spright_cfg_s *sigshared_cfg;
...
//            return -1;
//        }
//        printf("SKMSG metadata: PID %d; socket FD %d; Fn ID %d\n", buffer[0], buffer[1], buffer[2]);
//
...
//        }
//
//        printf("%s: NF_ID %d -> SOCKFD %d\n", MAP_NAME, buffer[2], sockfd_sk_msg_nf);
//
//        ret = close(sockfd_c);
//        if (unlikely(ret == -1))
//        {
...
{
    printf("Initializing sockmap manager...\n");
    ...
    //printf("Initializing SKMSG server...\n");
    ...
    //printf("Attaching SKMSG program to sockmap...\n");
