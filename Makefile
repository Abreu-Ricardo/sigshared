...
#CFLAGS += -Isrc/include -Isrc/cstl/inc -Isrc/log -MMD -MP -O3 -Wall -DLOG_USE_COLOR -fsanitize=address # Usando flags para depurar
...
all: sigshared bin shm_mgr gateway nf adservice currencyservice \
...
shm_mgr:  bin/shm_mgr_sigshared #bin/shm_mgr_rte_ring 

bin/shm_mgr_sigshared: src/io_sigshared.o src/shm_mgr.o $(COMMON_OBJS)
	@ echo "CC $@"
	@ $(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

gateway: bin/gateway_sigshared #bin/gateway_rte_ring 

bin/gateway_sigshared: src/io_sigshared.o src/gateway.o $(COMMON_OBJS) 
	@ echo "CC $@"
	@ $(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

nf: bin/nf_sigshared #bin/nf_rte_ring 

bin/nf_sigshared: src/io_sigshared.o src/nf.o $(COMMON_OBJS)
	@ echo "CC $@"
	@ $(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS) $(LDLIBS)

adservice: bin/nf_adservice_sigshared # bin/nf_adservice_rte_ring
...
currencyservice:  bin/nf_currencyservice_sigshared #bin/nf_currencyservice_rte_ring
...
emailservice:  bin/nf_emailservice_sigshared #bin/nf_emailservice_rte_ring
...
paymentservice:  bin/nf_paymentservice_sigshared #bin/nf_paymentservice_rte_ring
...
shippingservice:  bin/nf_shippingservice_sigshared #bin/nf_shippingservice_rte_ring
...
productcatalogservice:  bin/nf_productcatalogservice_sigshared #bin/nf_productcatalogservice_rte_ring
...
cartservice:  bin/nf_cartservice_sigshared #bin/nf_cartservice_rte_ring
...
recommendationservice:  bin/nf_recommendationservice_sigshared #bin/nf_recommendationservice_rte_ring
...
frontendservice:  bin/nf_frontendservice_sigshared #bin/nf_frontendservice_rte_ring
...
checkoutservice:  bin/nf_checkoutservice_sigshared #bin/nf_checkoutservice_rte_ring
